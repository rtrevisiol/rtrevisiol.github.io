...
const calcolo = (n, k) => {
  ...
  document.getElementById("result").innerHTML = "ci sono " + res + " combinazioni senza ripetizioni";
  confirm("Ci sono "+res+" combinazioni senza ripetizione.");
  return res;
}
...
/*   for (var u = 0; u < 1 << n; u++) {
  ...
  console.log(k_combinations(arrNumb,c));
